...
const FooterComponent = () => {
    return (
        <>
            <div className="container-fluid foot_bg bg-dark text-white-50 footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <div className="row g-5">
                        ...
                        <div className="col-lg-3 col-md-6">
                            ...
                            <div className="position-relative mx-auto " style={{ maxWidth: " 400px" }}>
                                ...
                                <button type="button" className="btn btn-primary py-2 position-absolute top-0 end-0  mt-3 me-2">SignUp</button>
                            </div>
                        </div>
                    </div>
                </div>
